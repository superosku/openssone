import {IPiece, Piece, PieceExtraInfo, PieceSideType} from "./Piece";
...
export const allRotatedPieces = allPieces.reduce((acc: Piece[], piece) => {
  return [
    ...acc,
    piece,
    piece.getRotated(1),
...
export function getRandomPiece(): IPiece {
